...
- **Cities should be prettier.** The city-block rendering is functional but plain; the designer wants urban areas to read as richer, more characterful places in the graphics pass (deferred with the rest of the overhaul — flagged so it isn't lost). *(In progress: the "world alive" pass adds richer non-gridded cities + small towns + ambient life.)*
