...
- **SPACE BATTLESHIPS** — bigger spaceships built to slug it out in orbit for prolonged periods → opens the deep-orbit theater as a real contested place. Sky / Sea / **Space** = same keystone, three domains.
...
- **Reframes the waves:** each escalation = another catapult launch from the homeworld (great structural justification for the endless invasion).
