...
- **In-flight agents:** Enemy Escalation v2 (snowball drops + all-super groundfall warnings + ~5 opening bombarders) and a Small/QoL batch — both dispatched after the v3.36.0 deploy.
